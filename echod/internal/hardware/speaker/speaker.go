...
const (
	...
	// period and periods, the ring geometry, are the device's own: see paths_dot.go and
	// paths_cronos.go. On cronos the vendor driver panics the kernel past 12 KB.
