...
// The capture codec accepts one format only: 16 kHz, S24_3LE. Channels, Mics, CenterMic and the
// loopback layout are the device's own — see device_dot.go and device_cronos.go.
const (
	Rate = 16000
	Bits = 24
